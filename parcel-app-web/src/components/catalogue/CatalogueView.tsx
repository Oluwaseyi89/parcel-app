      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="flex items-center space-x-4">
              <div className="flex border border-gray-300 rounded-lg overflow-hidden">
                <button
                  ...
                  className={`px-4 py-2 ${viewMode === "grid" ? "bg-danger text-white" : "bg-white text-gray-700"}`}
                >
                  <Grid className="w-5 h-5" />
                </button>
                <button
                  onClick={() => setViewMode("list")}
                  className={`px-4 py-2 ${viewMode === "list" ? "bg-danger text-white" : "bg-white text-gray-700"}`}
                >
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-white border border-gray-300 rounded-lg pl-4 pr-10 py-2 focus:outline-none focus:ring-2 focus:ring-danger focus:border-transparent"
              >
                {sortOptions.map((opt) => (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredProducts.map((product) => (
              ...
              >
                <div className="relative">
                  <div
                    className={`h-48 ${product.imageColor} flex items-center justify-center relative overflow-hidden`}
                  >
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button className="bg-danger text-white px-4 py-2 rounded-lg text-sm hover:brightness-90 transition-all font-medium flex items-center">
              ...
              >
                <div className="flex flex-col md:flex-row">
                  <div className="md:w-1/4">
                    <div
                      className={`h-48 md:h-full ${product.imageColor} flex items-center justify-center relative`}
                    >
                    ...
                    <div className="flex flex-col h-full justify-between">
                      <div>
                        ...
                        <p className="text-gray-600 mb-4">
                          Premium quality product with excellent customer reviews. Includes
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex space-x-3">
                          ...
                          <button className="bg-danger text-white px-6 py-2 rounded-lg hover:brightness-90 transition-all font-medium flex items-center">
                            <ShoppingCart className="w-4 h-4 mr-2" />
                            Add to Cart
                          </button>
                        </div>
        ...
        <div className="mt-12 flex justify-center">
          <nav className="flex items-center space-x-2">
            ...
            <button className="px-4 py-2 bg-danger text-white rounded-lg">1</button>
        ...
        {/* Newsletter CTA */}
        <div className="mt-16 bg-linear-to-r from-blue-50 to-indigo-50 rounded-2xl p-8 text-center">
          <h2 className="text-2xl font-bold text-gray-800 mb-4">
            Can&apos;t Find What You&apos;re Looking For?
          </h2>
          <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
            Sign up for our catalogue updates and be the first to know about new arrivals and
            restocks.
          </p>
          <div className="max-w-md mx-auto flex flex-col sm:flex-row gap-3">
            <input
              ...
              className="grow px-6 py-3 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-danger focus:border-transparent"
            />
            <button className="bg-danger text-white font-bold px-6 py-3 rounded-full hover:brightness-90 transition-all whitespace-nowrap">
              Notify Me
            </button>
          </div>
        </div>
