...
class EndpointRbacMatrixTests(TestCase):
    ...
    def test_rbac_matrix_for_all_routed_api_endpoints(self):
        endpoints = [
            ...
            {"name": "payment_register", "method": "options", "path": "/order/payments/register/", "allowed_roles": self.AUTHENTICATED_ROLES},
            {"name": "payment_context", "method": "options", "path": "/order/payments/RBAC-PAY-REF/context/", "allowed_roles": self.AUTHENTICATED_ROLES},
